...
import com.baomidou.mybatisplus.core.domain.BaseDomain;
    ...
    public Object execute(SqlSession sqlSession, Object[] args) {
        ...
        switch (command.getType()) {
            case INSERT: {
                ...
                //增加默认字段 createTime 和 updateTime
                if (param instanceof BaseDomain) {
                    BaseDomain baseDomain = (BaseDomain) param;
                    baseDomain.setCreateTime(baseDomain.getCreateTime() == null ? currentTimeMills : baseDomain.getCreateTime());
                    baseDomain.setUpdateTime(baseDomain.getUpdateTime() == null ? currentTimeMills : baseDomain.getUpdateTime());
                }
